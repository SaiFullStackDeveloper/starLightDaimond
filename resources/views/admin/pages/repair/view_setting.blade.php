            ...
            <div class="dashboard_right">
                <div class="das_right_inr">
                    <div class="das_tab_menu">
                        ...
                        <form method="post" action="{{ route('update_repair_setting') }}">
                            @csrf
                            <div class="das_frm_bx">
                                ...
                                @php
                                $mounting = get_repair_list(3);
                                $mounting_log = array();
                                if($order->id){
                                    $mounting_log = get_repair_forward_log($order->id,3);
                                }
                                @endphp
                                </div>
                                        ...
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                                <div class="input_bx">
                                                    ...
                                                    <select class="" style="width: 100%;" name="" id="get_repair_setting_data">
                                                        <option value="0" selected>Select</option>

                                    ...
                                    <tr>
                                      ...
                                      <td class="incon_css">
                                        @if (check_repair_forward($item->id,3))
                                         ...
                                         @else
                                         <span><a  href="{{ url('repair_filling_form/'.$item->id) }}"><i class="fas fa-eye"></i></a></span>
                                         @endif
                                      ...
                                      <td  class="incon_css">
                                        @if(check_repair_status($item->id,3))
                                          ...
                                          <div><span class="text-danger">Pending</span></div>
                                          @else
                                          <span><a  href="{{ url('repair_Setting_Form/'.$item->id) }}"><i class="fas fa-eye"></i></a></span>
                                          @endif
                                        @endif
                                      ...
                                      <td  class="incon_css">
                                        @if(check_repair_status($item->id,4))
                                          ...
                                          <div><span class="text-danger">Pending</span></div>
                                          @else
                                          <span><a  href="{{ url('repair_final_Form/'.$item->id) }}"><i class="fas fa-eye"></i></a></span>
                                          @endif
                                        @endif

            ...
            <div class="dashboard_right">
                <div class="das_right_inr">
                    ...
                    <div class="das_frm_panel">
                        <form action="{{ route('update_repair_filling_form') }}" method="post">
                            {{ csrf_field() }}
                            <div class="das_frm_bx">
                                ...
                                @php
                                $filling = get_repair_list(1);
                                $forward_log = array();
                                if($order->id){
                                    $forward_log = get_repair_forward_log($order->id,1);
                                        ...
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                                <div class="input_bx">
                                                    ...
                                                    <select class="" style="width: 100%;" name="" id="get_repair_FillingForm_data">
                                                        <option value="0" selected>Select</option>

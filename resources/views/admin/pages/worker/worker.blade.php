          ...
          <td>
            <div class="ac_di">
                <ul>
                    ...
                    <li>
                      <span title='Delete manager' style="cursor: pointer;" onclick="delete_manager({{$item->id}})" data-toggle="modal" data-target="#user_delete_modal" class="badge badge-light  badge-lg"><img src="{{ asset('assets/images/action3.png" alt=""></span>
                    </li>
                    @else
                    ...
                    @endif
                    <li>
                      <span style="cursor: pointer;" onclick="fetch_user_details({{$item->id}})" data-toggle="modal" data-target="#user_details_modal" class="badge badge-light  badge-lg"><img src="{{ asset('assets/images/about.png" alt=""></span>
                      ...
                      <input type="hidden" id="worker_identity_{{$item->id}}" value="{{ asset('uploads/'.$item->identity_doc) }}">

...
if ($main_data) {
    ...
    $fp_reciv = $main_data->fp_reciv;
    $fp_dust = $main_data->fp_dust;
}
@endphp
                ...
                <div class="das_right_inr">
                    <div class="das_tab_menu">
                        <ul>
							...
							<li class="actv"><a href="{{ route('final_Form',$order->id) }}">Final Polish</a></li>
                        </ul>
                    </div>
                    <div class="das_frm_panel">
                        <form method="post" action="{{ route('update_final_polish') }}">
                            @csrf
                            <div class="das_frm_bx">
                                ...
                                $mounting_log = array();
                                if($order->id){
                                    $mounting_log = get_forward_log($order->id,4);
                                }
                                @endphp
                                </div>
                                </div>
                                <div class="frm_inp_top">
                                    <div class="row">
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                                <div class="input_bx">
                                                    ...
                                                    <select class="" style="width: 100%;" name="" id="get_finalpolish_data">
                                                        <option value="0" selected>Select</option>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 mt-4">
                                            ...
                                            @else
                                            <span><a  href="{{ url('final_Form/'.$order->id) }}"><i class="fas fa-eye vieweyeicon"></i></a></span>
                                            @endif
                                            @endif
                                        </div>
                                        @endif
                                    ...
                                    <div class="row">
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6">
                                            <div class="input_bx">
                                                ...
                                                <input type="text" placeholder="Enter here" value="{{ $gram_issue }}" name="fp_issue" id="fp_issue">
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6">
                                            <div class="input_bx" id="recGram">
                                                <span>Gram received</span>
                                                <input type="text" placeholder="Enter here" value="{{ $fp_reciv }}" onkeyup="count_fp_dast()" id="fp_reciv" name="fp_reciv">
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6">
                                            <div class="input_bx">
                                                <span>Dust</span>
                                                <input type="text" placeholder="Enter here" value="{{ $fp_dust }}" name="fp_dust" id="fp_dust">
                                            </div>
                                        </div>
                                        {{-- <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6">
                                            <div class="input_bx">
                                        ...
                                        {{-- <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6">
                                            <div class="input_bx">
                                                <span>Recive</span>
                                                <input type="text" placeholder="Enter here"  name="recive" value="{{ $order->recive }}">
                                            </div>
                                        </div> --}}
